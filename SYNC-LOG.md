...
## 2026-07-29
- **Local/Hub** — folder reorg shipped + **hub published** (`c577192`): numbered structure (00-decisions … 06-v8-complementary), registers (OPEN-ACTIONS), 23-ADR decision log, hub audience/track filters. Was 3 versions behind → now v3.3-aligned. `_deploy.sh` hardened after a stale-stash pop landmine.
