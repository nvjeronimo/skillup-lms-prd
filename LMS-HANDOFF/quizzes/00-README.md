...
| [09-handoff-map.md](09-handoff-map.md) | **What controls each component property?** Every Figma property crossed against what actually drives it — an edX setting, authored OLX, runtime state, or something we build. Read before implementing anything from the boards: ten of the Question Card's twelve booleans are configuration, not code. |
