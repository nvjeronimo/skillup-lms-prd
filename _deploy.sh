...
git add -A 04-research/ 05-source-docs/ 06-platform-pages/ 90-prototypes/ archive/ 2>/dev/null || true
...
Deploy the current hub + numbered structure (00-decisions … 06-platform-pages),
